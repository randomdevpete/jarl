...
import { createRootRouteAtom, queryParamRouteAtom, requireMatch, transformRouteAtom } from "jarl-atoms";
...
const gridRoot = createRootRouteAtom({ basePath: "/demos/data-grid" });
